...
<body class="CyrLatConvert">
	...
	<div id="container" class="header3">
		...
		<div id="content">
			...
			<div class="section-content page-banner-section">
				<div class="container">
					...
					<ul>
						...
						<?php
							if (isset($_GET['id'])) { ?>
								<li><a style="color: #a21f1e;" href="arhiva.php">Aktuelne vesti</a></li>
								<li><a style="color: #a21f1e;" href="#"><?php echo $header_title ?></a></li>
								<?php
							}
							else{ ?>
								<li><a style="color: #a21f1e;" href="#">Aktuelne vesti</a></li>
								<?php		
							}
						?>
					</ul>
			...
			<!-- blog-section
				================================================== -->
			<div class="section-content blog-section blog-medium">
				<div class="container">
					<div class="blog-box">
						<?php
