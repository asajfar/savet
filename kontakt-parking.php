...
<head>
	<title>Parking - Pohvale i primedbe - Savet za koordinaciju poslova bezbednosti saobraćaja na putevima na teritoriji Grada Novog Sada</title>
	<meta charset="utf-8">
					...
					<div class="row">
						<div class="col-md-9">
							<form id="contact-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>#contact-form" method="POST">
								...
								<div class="row">
									<input type="hidden" name="kategorija" value="PARKING">
									<div class="col-md-6">
