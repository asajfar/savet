...
<head>
	<title>Putna infrastruktura - pohvale i primedbe - Savet za koordinaciju poslova bezbednosti saobraćaja na putevima na teritoriji Grada Novog Sada</title>
	<meta charset="utf-8">
					...
					<div class="row">
						<div class="col-md-9">
							<form id="contact-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>#contact-form" method="POST">
								<h1>Putna infrastruktura</h1>
								<h2>Pošaljite pohvalu/primedbu</h2>
								<div class="row">
									<input type="hidden" name="kategorija" value="PUTNA INFRASTRUKTURA">
									<div class="col-md-6">
