<?php
  ...
  $stmt = $panel_home->runQuery("SELECT tbl_members.memberName, tbl_members.memberLastname, tbl_members.memberLocation, tbl_comments.commentSection, tbl_comments.commentContent, tbl_comments.commentDate FROM tbl_comments LEFT JOIN tbl_members ON tbl_comments.memberID=tbl_members.memberID");
  $stmt->execute();
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div style="margin-bottom: 15px">
                Isključi/uključi kolone za prikaz: <a href="#" class="toggle-vis" data-column="0">Ime</a> - <a href="#" class="toggle-vis" data-column="1">Prezime</a> - <a href="#" class="toggle-vis" data-column="2">Deo grada</a> - <a href="#" class="toggle-vis" data-column="3">Komentar</a> - <a href="#"  class="toggle-vis" data-column="4">Datum</a>
              </div>
              <table id="tabela1" class="table table-hover table-bordered table-striped">
                <thead>
                  <tr>
                      <th>Ime</th>
                      <th>Prezime</th>
