<?php
	...
	$image = get_string_between($str, "[img]", "[/img]");
	      ...
	      $title = "<title>".$header_title."</title>\n";
	       ...
	       $title = "<title>Sednice Saveta - Savet za koordinaciju poslova bezbednosti saobraćaja na putevima na teritoriji Grada Novog Sada</title>\n";
	    }
 ?>
...
<body class="CyrLatConvert">
	...
	<div id="container" class="header3">
		...
		<div id="content">
			...
			<div class="section-content page-banner-section">
				<div class="container">
					...
					<ul>
						...
						<?php
							if (isset($_GET['id'])) { ?>
								<li><a style="color: #a21f1e;" href="sednice.php">Sednice Saveta</a></li>
								<li><a style="color: #a21f1e;" href="#"><?php echo $header_title ?></a></li>
								<?php
							}
							else{ ?>
								<li><a style="color: #a21f1e;" href="#">Sednice saveta</a></li>
								<?php		
							}
						?>
					</ul>
			...
			<!-- blog-section
				================================================== -->
			<div class="section-content sednice blog-section blog-medium">
				<div class="container">
					<div class="blog-box">
						<?php
