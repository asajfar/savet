<?php
	...
	$image = get_string_between($str, "[img]", "[/img]");
	      ...
	      $title = "<title>".$header_title."</title>\n";
	       ...
	       $title = "<title>Servisne informacije - Savet za koordinaciju poslova bezbednosti saobraćaja na putevima na teritoriji Grada Novog Sada</title>\n";
	    }
 ?>
...
<head>
	<!-- <title>Savet za koordinaciju poslova bezbednosti saobraćaja na putevima na teritoriji Grada Novog Sada - Arhiva vesti</title> -->
...
<body class="CyrLatConvert">
	...
	<div id="container" class="header3">
		...
		<div id="content">
			...
			<div class="section-content page-banner-section">
				<div class="container">
					...
					<ul>
						...
						<?php
							if (isset($_GET['id'])) { ?>
								<li><a style="color: #a21f1e;" href="arhiva.php">Servisne informacije</a></li>
								<li><a style="color: #a21f1e;" href="#"><?php echo $header_title ?></a></li>
								<?php
							}
							else{ ?>
								<li><a style="color: #a21f1e;" href="#">Servisne informacije</a></li>
								<?php		
							}
						?>
					</ul>
			...
			<!-- blog-section
				================================================== -->
			<div class="section-content blog-section blog-medium servis">
				<div class="container">
					<div class="blog-box">
						<?php
						    ...
						    $template = "savet2";
						    $category = "2";
						    include("/home/uprava/public_html/testsite/cnews/show_news.php");
						?>	
					</div>
